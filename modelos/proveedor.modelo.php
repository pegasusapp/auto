...
class ModeloSolicitud{
  ...
  /*=============================================
	...
	static public function mdlConsultaProveedores($tabla, $item, $valor)
  {
			$stmt = Conexion::conectar()->prepare("SELECT count(*) as cantidad FROM $tabla WHERE $item = '".$valor."' LIMIT 1");
