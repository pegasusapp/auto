 ...
 */
  ...
  var getdetails_user_data = function(codigo_usuario) {


        return $.getJSON("modelos/consulta.php", {

            "codigo_usuario_data": codigo_usuario
...
$('[data-usu-consulta-codigo]').click(function(e)
                      {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _showNext: function () {
            ...
            for (var i = si; i < this.steps.length; i++) 
                ...
                // acotamos la consulta al paso 2 solamente
                if(si==1)
                {
                     
                    if (document.getElementById('codUsuario').value!="")
                        {
                            var vlr_usuario_data=document.getElementById('codUsuario').value;
                            getdetails_user_data( vlr_usuario_data )
                            .done(function(response)
                            {
                              if (response.success)
                                {
                      ...
                      .fail(function(jqXHR, textStatus, errorThrown)
                        ...
                        {
                            // habilitamos el campo de busqueda por niu
                            $("#idClienteEnergia").prop('disabled', false);
        ...
        _showPrevious: function () {
           ...
           /* if(si==0)
                {
                        //alert("Hola estas en la primera");
